...
> 版本 0.1.0 · macOS 13 Ventura 或更高版本 · Apple Silicon
...
在 [Releases](https://github.com/zszbyzsz/aibar/releases) 下载 `aibar-0.1.0.zip`，解压后将 `aibar.app` 拖入“应用程序”文件夹并打开。
...
Download `aibar-0.1.0.zip` from [Releases](https://github.com/zszbyzsz/aibar/releases), unzip it, drag `aibar.app` to Applications, and open it.
